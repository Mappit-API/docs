...
extensions = [
    ...
    # HTTP blocks in the docs
    'sphinxcontrib.httpdomain',
    # Provides GraphiQL blocks in the docs
    "sphinx_graphql",
]
...
rst_epilog = """
.. _Dashboard:
    https://dashboard.mappit.app/

.. _GraphQL:
    https://api.mappit.app/graphql/
"""
...
html_theme_options = dict(style_nav_header_background="rgb(65, 130, 228)")
